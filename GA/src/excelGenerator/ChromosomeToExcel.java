...
public class ChromosomeToExcel {
	...
	public void converterChromosomeToExcelRow2(List<ChromosomeBinary> chromosomes, int generation, long time) throws Exception {
		...
		excelGenerator.insertCellInfo(generation + 1, 8, "" + Classification.getInstance().getSeed(), Cell.CELL_TYPE_NUMERIC);
