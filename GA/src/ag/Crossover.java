...
public class Crossover {
	...
	public List<ChromosomeBinary> randomPoint(List<ChromosomeBinary> parents) throws Exception {
		return onePoint(parents, ThreadLocalRandom.current().nextInt(1, parents.get(0).countGenes()));
